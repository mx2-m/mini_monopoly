 ...
 *  @author dermetfan
 *   //http://www.java2s.com/example/java-src/pkg/com/stercore/code/net/dermetfan/utils/libgdx/graphics/animatedsprite-6428a.html*/
public class AnimatedSprite extends Sprite {
    ...
    public void draw(Batch batch) {
        ...
        if (centerFramesEnabled) {
            ...
            setBounds(oldX + differenceX / 2, oldY + differenceY / 2, oldWidth - differenceX,
                    oldHeight - differenceY);
        }
